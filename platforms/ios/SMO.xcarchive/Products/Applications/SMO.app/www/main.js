...
var map = {
	"../actividad/actividad.module": [
		"./src/app/pages/actividad/actividad.module.ts",
		"default~actividad-actividad-module~ponente-ponente-module~programa-programa-module",
		"common",
		"actividad-actividad-module"
	],
	...
	"../congresistas/congresistas.module": [
		"./src/app/pages/congresistas/congresistas.module.ts",
		"common",
		"congresistas-congresistas-module"
	],
	"../congresos/congresos.module": [
	...
	"../esquema/esquema.module": [
		"./src/app/pages/esquema/esquema.module.ts",
		"esquema-esquema-module"
	],
	"../expocomercial/expocomercial.module": [
	...
	"../mesadirectiva/mesadirectiva.module": [
	...
	"../ponente/ponente.module": [
		"./src/app/pages/ponente/ponente.module.ts",
		"default~actividad-actividad-module~ponente-ponente-module~programa-programa-module",
		"common",
		"ponente-ponente-module"
	],
	"../ponentes/ponentes.module": [
...
/* harmony import */ var _components_cartel_cartel_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/cartel/cartel.component */ "./src/app/components/cartel/cartel.component.ts");
...
/***/ "./src/app/components/cartel/cartel.component.html":
/*!*********************************************************!*\
  !*** ./src/app/components/cartel/cartel.component.html ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "<ion-content>\n\n<ion-card *ngFor=\"let car of cartel\">\n  <img src=\"./madison.jpg\">\n  <ion-card-header>\n    <ion-card-subtitle>{{car.especialidad}}</ion-card-subtitle>\n  </ion-card-header>\n  <ion-card-content>\n    <p>Titulo: {{car.titulo}}</p>\n    <p>Autores: {{car.autores}}</p>\n    <p>Coautores: {{car.coautores}}</p>\n  </ion-card-content>\n</ion-card>\n</ion-content>\n<ion-footer  no-border>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-button (click)=\"regresar()\">\n        <ion-icon slot=\"start\" name=\"arrow-aroud-back\"></ion-icon>\n        <ion-label>Regresar</ion-label>\n      </ion-button>\n    </ion-buttons>\n    <ion-buttons slot=\"end\" color=\"primary\">\n      <ion-button >\n        <ion-icon slot=\"end\" name=\"start-outline\"></ion-icon>\n        <ion-label>Favorito</ion-label>\n      </ion-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-footer>"

/***/ }),

/***/ "./src/app/components/cartel/cartel.component.scss":
/*!*********************************************************!*\
  !*** ./src/app/components/cartel/cartel.component.scss ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvY2FydGVsL2NhcnRlbC5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/components/cartel/cartel.component.ts":
/*!*******************************************************!*\
  !*** ./src/app/components/cartel/cartel.component.ts ***!
  \*******************************************************/
/*! exports provided: CartelComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CartelComponent", function() { return CartelComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_services_carteles_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/carteles.service */ "./src/app/services/carteles.service.ts");
...
var CartelComponent = /** @class */ (function () {
    ...
    CartelComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-cartel',
            template: __webpack_require__(/*! ./cartel.component.html */ "./src/app/components/cartel/cartel.component.html"),
            styles: [__webpack_require__(/*! ./cartel.component.scss */ "./src/app/components/cartel/cartel.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_carteles_service__WEBPACK_IMPORTED_MODULE_2__["CartelesService"],
...
var URL_SERVICIOS = "https://wsbrb-services.com/appsmo/servicios";
...
/***/ "./src/app/services/carteles.service.ts":
/*!**********************************************!*\
  !*** ./src/app/services/carteles.service.ts ***!
  \**********************************************/
/*! exports provided: CartelesService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CartelesService", function() { return CartelesService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var CartelesService = /** @class */ (function () {
    ...
    CartelesService.prototype.getDetalles = function (id) {
        ...
        var url = _config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVICIOS"] + "/cartel.php?id=" + id;
    ...
    CartelesService.prototype.cargar_todos = function () {
        ...
        if (!this._as.online) {
            ...
            this._as.presentLoading("Cargando...");
            var url = _config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVICIOS"] + "/carteles.php?todos&pagina=" + this.pagina;
            var promesa = this.http.get(url)
                .toPromise()
                .then(function (data) {
                _this.carteles = data.resultados;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = _config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVICIOS"] + "/carteles.php?todos&pagina=" + this.pagina;
                        return [4 /*yield*/, this.http.get(url)
                                .toPromise()
                                .then(function (data) {
                                var _a;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2:
                        url = _config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVICIOS"] + "/carteles.php?search=" + variable;
                        return [4 /*yield*/, this.http.get(url)
                                .toPromise()
                                .then(function (data) {
                                _this.carteles = null;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        url = _config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVICIOS"] + "/carteles.php?todos&pagina=" + this.pagina + "&search=" + variable;
                        return [4 /*yield*/, this.http.get(url)
                                .toPromise()
                                .then(function (data) {
                                if (data.resultados.length > 0) {
    ...
    CartelesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
...
/* harmony import */ var _ajustes_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ajustes.service */ "./src/app/services/ajustes.service.ts");
...
var DatosService = /** @class */ (function () {
    ...
    DatosService.prototype.guardarCarteles = function () {
        var _this = this;
        var url = _config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVICIOS"] + "/carteles.php?getall";
        var promesa = this.http.get(url)
            .toPromise()
            .then(function (data) {
            if (data.resultados.length > 0) {
    ...
    DatosService.prototype.guardarProfesores = function () {
        var _this = this;
        var url = _config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVICIOS"] + "/profesores.php?getall";
        var promesa = this.http.get(url)
            .toPromise()
            .then(function (data) {
    ...
    DatosService.prototype.guardarVideos = function () {
        var _this = this;
        var url = _config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVICIOS"] + "/videos.php?getall";
        var promesa = this.http.get(url)
            .toPromise()
            .then(function (data) {
            if (data.resultados.length > 0) {
    ...
    DatosService.prototype.guardarActividades = function () {
        var _this = this;
        var url = _config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVICIOS"] + "/minutoxminuto.php?getall";
        var promesa = this.http.get(url)
            .toPromise()
            .then(function (data) {
    ...
    DatosService.prototype.guardarPatrocinadores = function () {
        var _this = this;
        var url = _config_url_servicios__WEBPACK_IMPORTED_MODULE_3__["URL_SERVICIOS"] + "/patrocinadores.php?getall";
        var promesa = this.http.get(url)
            .toPromise()
            .then(function (data) {
            if (data.resultados.length > 0) {
    ...
    DatosService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"],
            ...
            _ajustes_service__WEBPACK_IMPORTED_MODULE_6__["AjustesService"]])
    ], DatosService);
    return DatosService;
}());
...
var PushService = /** @class */ (function () {
    ...
    PushService.prototype.configuracionInicial = function () {
        ...
        this.oneSignal.getIds().then(function (info) {
            ...
            console.log("ID notifi: " + _this.userID);
        });
